            ...
            <div className="container search"  >
                <div className="container item-container" style={{marginTop:'60px'}}>
                    <div className="row d-flex justify-content-start">
                        ...
                        {searchresult.length >= 1 ? searchresult.map(data => <div className="col-6 col-md-6 col-lg-3 ">
                            <Card style={{ marginTop: "20px" }} className='card' key={data.id} onClick={() => navigate(`/product/${data.id}`, { replace: 'true' })}>
