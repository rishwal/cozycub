...
import img1 from '../Data/images/care-3.jpg'
import img2 from '../Data/images/toy-6.jpg'
    ...
    return (
        <div id='parent-div'>
            <div className="filter-container container">
                ...
                <Dropdown >
                    <Dropdown.Toggle variant="primary" id="dropdown-basic" style={{ backgroundColor: "transparent", border: 'none', color: 'black' }}>
                        Product
                    </Dropdown.Toggle>
                ...
                <Dropdown style={{ backgroundColor: "transparent", border: 'none', color: 'black' }}>
                    <Dropdown.Toggle variant="primary" id="dropdown-basic" style={{ backgroundColor: "transparent", border: 'none', color: 'black' }}>
                        filter
                    </Dropdown.Toggle>
            ...
            <div className="container item-container">
                <div className="row justify-content-start" >
                    {filteredData.map(data => <div className="col-6 col-md-6 col-lg-3">
                        <Card style={{ marginTop: "20px" }} className='shop-card' key={data.id} onClick={() => navigate(`/product/${data.id}`, { replace: 'true' })}>
                            ...
                            <Card.Body className='shop-card-body'>
                                ...
                                <p style={{ marginBottom: '10px' }}> {data.description.slice(0, 13)}...</p>
                            </Card.Body>
                        </Card>
                    </div>)}
